document.getElementById("btnInscription").addEventListener("click", async (e) => {
    ...
    if (answer.error === "mail existant") {
        erreur.textContent = "Ce mail appartient déjà à un compte existant.";
    } else if (answer.error === "pseudo existant") {
        erreur.textContent = "Ce pseudo appartient déjà à un compte existant.";
    } else if (answer.error === "Champs manquants") {
